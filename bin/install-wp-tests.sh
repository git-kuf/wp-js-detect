...
install_wp() {
    ...
    do
        ...
        mkdir $element
		cp -r temporary_plugin_copy/trunk/* $element
...
php_tools() {
  ...
  # - phpcs --standard=PSR1 .
  # - phpcs --standard=PSR2 .
  phpcs --standard=WordPress --warning-severity=1 -p -v --report=full $WP_CORE_DIR"wp-content/plugins/wp-js-detect/wp-js-detect.php"
