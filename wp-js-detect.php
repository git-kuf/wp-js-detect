	...
	public function plugin_settings() {
		...
		<div class="wrap">
			...
			<a class="nav-tab <?php echo ( $tab == '' ) ? 'nav-tab-active' : ''; ?>"
			   href="<?php echo admin_url( '/admin.php?page=js-detect-settings' ); ?>"><?php _e( 'Plugin Settings', 'js-detect' ); ?></a>
			<a class="nav-tab <?php echo ( $tab == 'css' ) ? 'nav-tab-active' : ''; ?>"
			   href="<?php echo admin_url( '/admin.php?page=js-detect-settings&tab=css' ); ?>"><?php _e( 'Plugin CSS', 'js-detect' ); ?></a>
			<a class="nav-tab <?php echo ( $tab == 'contact' ) ? 'nav-tab-active' : ''; ?>"
			   href="<?php echo admin_url( '/admin.php?page=js-detect-settings&tab=contact' ); ?>"><?php _e( 'Contacts Me', 'js-detect' ); ?></a>
			<?php if ( $tab === 'contact' ): ?>
				<table cellspacing="0" class="widefat post fixed" style="width: 100%">
					...
					<tr>
						<td class="column">
							...
							<p><?php _e( 'Email', 'js-detect' ); ?>: <a href="mailto:kuflievskiy@gmail.com">kuflievskiy@gmail.com</a>
							</p>

							<p><?php _e( 'Author URI', 'js-detect' ); ?>: <a href="https://github.com/git-kuf/"
							                                                 target="_blank">https://github.com/git-kuf/</a>
							</p>
						</td>
					</tr>
					</tbody>
			...
			<?php elseif ( $tab === 'css' ) : ?>
				<table cellspacing="0" class="widefat post fixed" style="width: 100%">
					...
					<tr>
						<td class="column">
							<label
								for="wp_non_js_notification_css"><?php _e( 'No Js Notification CSS', 'js-detect' ); ?>
								:</label>
						</td>
			...
			<?php
				...
				<table cellspacing="0" class="widefat post fixed" style="width: 100%">
					...
					<tr>
						<td class="column">
							<label for="wp_non_js_notification_text"><?php _e( 'No Js Notification', 'js-detect' ); ?>
								:</label>
						</td>
						<td align="right" class="column">
							<form action="#" method="post">
